  ...
  angular.module('app._shared.views.mini-grid')
    .controller('miniGridController', [
      ...
      function($api, $tools, $views, queryParamsFactory, login, $alert, saleEventDetails, $timeout, swagger) {
        ...
        vm.internalControlMiniGrid = vm.controlMiniGrid || {};
        //# View definition
        ...
        var loadOnEndOfScroll = function() {
          var limit = $('#last-element-minigrid');
          var win = $(window);
          var viewport = {
            top: win.scrollTop(),
            left: win.scrollLeft()
        ...
        var _initConfiguration = function() {
          ...
          swagger.composeFields(vm.entity).then(function(availableFields) {
            ...
            $api.getEntity(configurationsEntity, function(success) {
              ...
              vm.internalControlMiniGrid.load();
            });
          });
        };

        vm.internalControlMiniGrid.load = function() {
